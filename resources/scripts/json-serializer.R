# Minimal JSON serializer for announce payloads.
# No external dependencies (jsonlite not required).
# Supports: character, integer, numeric, logical, NULL.
# Does NOT support: factors, Date/POSIXt, nested lists, NA, non-finite numbers.
